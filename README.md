...
4. ถ้ารายชื่อหาย ให้ไปหน้า `ตั้งค่า` แล้วกด `นำเข้ารายชื่อ`

ปุ่ม `นำเข้ารายชื่อ` ใช้ข้อมูลจาก `src/data/students_p4_2_roster.json` ซึ่งสร้างจากชุดข้อมูลจริงเดียวกับระบบ GAS

ถ้าต้องการนำเข้ารายชื่อโดยตรงผ่าน SQL ให้รัน `supabase/seed_students_p4_2.sql` แทนข้อ 5 ได้ ไฟล์นี้เป็นรายชื่อจริงและไม่มีข้อมูลทดสอบ
